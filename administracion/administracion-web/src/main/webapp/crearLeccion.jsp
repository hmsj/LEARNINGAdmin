...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				<h2 class="section-title wow fadeInUp">AÑADE UNA LECCION AL CURSO</h2>
			</div>
			...
			<div class="col-md-6 col-md-offset-3 text-center wow fadeInUp">
				...
				<form method="post" action="material?accion=leccion" name="leccionForm"
					id="leccionForm" enctype="multipart/form-data">

					<select name="seccionLeccion" id="seccionLeccion">
							<option value="0" selected="selected"> Seleccione una seccion</option>
							<c:forEach items="${listadoSeccionesCurso }" var="seccion">
								<option value="${seccion.idSeccion }"> ${seccion.titulo }</option>
							</c:forEach>
					</select>
					...
					<fieldset>
						...
						<textarea name="descripcionLeccion" cols="40" rows="3"
							id="descripcionLeccion" placeholder="Descripcion de la leccion"></textarea>
					</fieldset>

...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				<h2 class="section-title wow fadeInUp">AÑADE UNA SECCION AL CURSO</h2>
			</div>
			...
			<div class="col-md-6 col-md-offset-3 text-center wow fadeInUp">
				...
				<form method="post" action="material?accion=seccion" name="seccionForm"
					...
					<fieldset>
						...
						<textarea name="descripcionSeccion" cols="40" rows="3"
							id="descripcionSeccion" placeholder="Descripcion de la seccion"></textarea>
					</fieldset>
